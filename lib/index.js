...
exports.get_data = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var split, command, function_name;
...
function logs(req, res, function_name) {
    return __awaiter(this, void 0, void 0, function () {
        var url, headers, params, log_res, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    url = CONFIG.openfaas_url + "/system/logs";
                    headers = { Authorization: CONFIG.airtable_key };
                    params = { name: function_name, tail: 10 };
...
function fetch_openfaas() {
    return __awaiter(this, void 0, void 0, function () {
        var url, headers, res, e_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    url = CONFIG.openfaas_url + "/system/functions";
                    headers = { Authorization: CONFIG.openfaas_key };
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, axios_1.default.get(url, { headers: headers })];
...
function combine(airtable_data, openfaas_data) {
    ...
    return uniq_names.map(function (uniq_name) {
        ...
        var airtable_fields = ['repo', 'hide_from_deploy', 'target_image_version', 'scale_to_zero', 'test_req', 'uses_template'];
...
function compute(basic) {
    ...
    var upgradable = !!(deployed && !util_1.isNull(basic.deployed_image_version) &&
        !util_1.isNull(basic.target_image_version) && (basic.deployed_image_version !== basic.target_image_version));
    var computed = {
        deployed: deployed,
        hideable: hideable,
        running: running,
