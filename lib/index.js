        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [2 /*return*/, combine(static_info, fn_status)];
                case 3:
                    e_1 = _a.sent();
...
function combine(static_info, fn_status) {
    return static_info.map(function (f) {
        var remote_image = lodash_1.get(find_image_by_name(f.function_name, fn_status), "image", "no image");
...
function find_image_by_name(name, fn_status) {
    return fn_status.find(function (s) { return s.function_name === name; });
}
